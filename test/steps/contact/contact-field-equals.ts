...
describe('ContactFieldEqualsStep', () => {
  ...
  it('should return expected step metadata', () => {
    ...
    expect(stepDef.getExpression()).to.equal('the (?<field>[a-zA-Z0-9_]+) field on dynamics crm contact (?<email>.+) should (?<operator>be set|not be set|be less than|be greater than|be one of|be|contain|not be one of|not be|not contain) ?(?<expectedValue>.+)?');
  ...
  it('should respond with pass if contact field matches expected value with no operator provided.', async () => {
  ...
  it("should respond with pass if contact field matches expected value with 'be' operator provided.", async () => {
    // Stub a response that matches expectations.
    const expectedRetrieveResponse: any = [
      {
        contactid:'anyId',
  ...
  it("should respond with pass if contact field matches expected value with 'not be' operator provided.", async () => {
    // Stub a response that matches expectations.
    const expectedRetrieveResponse: any = [
      {
        contactid:'anyId',
  ...
  it("should respond with pass if contact field matches expected value with 'contain' operator provided.", async () => {
    // Stub a response that matches expectations.
    const expectedRetrieveResponse: any = [
      {
        contactid:'anyId',
  ...
  it("should respond with pass if contact field matches expected value with 'not contain' operator provided.", async () => {
    // Stub a response that matches expectations.
    const expectedRetrieveResponse: any = [
      {
        contactid:'anyId',
  ...
  it("should respond with pass if contact field is an number field matches expected value with 'be greater than' operator provided.", async () => {
    // Stub a response that matches expectations.
    const expectedRetrieveResponse: any = [
      {
        contactid:'anyId',
  ...
  it("should respond with pass if contact field is a number field and matches expected value with 'be less than' operator provided.", async () => {
    // Stub a response that matches expectations.
    const expectedRetrieveResponse: any = [
      {
        contactid:'anyId',
  ...
  it("should respond with pass if contact field is a date field and matches expected value with 'be greater than' operator provided.", async () => {
    // Stub a response that matches expectations.
    const expectedRetrieveResponse: any = [
      {
        contactid:'anyId',
  ...
  it("should respond with pass if contact field is a date field and matches expected value with 'be less than' operator provided.", async () => {
    // Stub a response that matches expectations.
    const expectedRetrieveResponse: any = [
      {
        contactid:'anyId',
  ...
  it("should respond with error if contact field or expected field is number field but value is not a number and operator is 'be greater than'.", async () => {
    // Stub a response that matches expectations.
    const expectedRetrieveResponse: any = [
      {
        contactid:'anyId',
  ...
  it("should respond with error if contact field or expected field is number field but value is not a number and operator is 'be less than'.", async () => {
    // Stub a response that matches expectations.
    const expectedRetrieveResponse: any = [
      {
        contactid:'anyId',
  ...
  it('should respond with fail if contact field does not match expected value.', async () => {
    // Stub a response that matches expectations.
    const expectedRetrieveResponse: any = [
      {
        contactid:'anyId',
